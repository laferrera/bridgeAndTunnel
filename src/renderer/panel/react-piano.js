...
function buildMidiNumberAttributesCache() {
  return range(MIN_MIDI_NUMBER, MAX_MIDI_NUMBER + 1).reduce(function (
    cache,
    midiNumber
  ) {
...
var NATURAL_MIDI_NUMBERS = range(MIN_MIDI_NUMBER, MAX_MIDI_NUMBER + 1).filter(
  function (midiNumber) {
  ...
  (function (_React$Component) {
    ...
    function Key() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(Key)).call.apply(
          _getPrototypeOf2,
          [this].concat(args)
        )
      );
  ...
  (function (_React$Component) {
    ...
    function Keyboard() {
      ...
      return _possibleConstructorReturn(
        this,
        _getPrototypeOf(Keyboard).apply(this, arguments)
      );
    }
          ...
          return React.createElement(
            ...
            this.getMidiNumbers().map(function (midiNumber) {
              ...
              var isActive =
                ...
                _this.props.activeNotes.includes(midiNumber);
  ...
  if ((!first && first != 0) || !last) {
    return new Error(
      "Invalid prop "
        ...
        .concat(propName, " must be an object with .first and .last values.")
    );
  }
  ...
  if (!isNaturalMidiNumber(first) || !isNaturalMidiNumber(last)) {
    return new Error(
      "Invalid prop "
        ...
        .concat(
          propName,
          " values must be valid MIDI numbers, and should not be accidentals (sharp or flat notes)."
        )
    );
  }
  ...
  if (first >= last) {
    return new Error(
      "Invalid prop "
        .concat(propName, " supplied to ")
        .concat(componentName, ". ")
        .concat(propName, ".first must be smaller than ")
        .concat(propName, ".last.")
    );
  }
}
...
var ControlledPiano =
  ...
  (function (_React$Component) {
    ...
    function ControlledPiano() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(ControlledPiano)).call.apply(
          _getPrototypeOf2,
          [this].concat(args)
        )
      );
...
var Piano =
  ...
  (function (_React$Component) {
    ...
    function Piano() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(Piano)).call.apply(
          _getPrototypeOf2,
          [this].concat(args)
        )
      );
